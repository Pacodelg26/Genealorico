...
<body>
    ...
    if (isset($_GET['persona'])) {
        ...
        if ($row) {
            ...
            if ($row['PadreID']) {
                ...
                echo "<p>Padre: " . $padre['Nombre'] . " " . $padre['Apellido_Paterno'] . " " . $padre['Apellido_Materno'] . "</p>";
            }
            if ($row['MadreID']) {
            ...
            while ($hijo = $stmtHijos->fetch()) {
                echo "<p>Hijo: " . $hijo['Nombre'] . " " . $hijo['Apellido_Paterno'] . " " . $hijo['Apellido_Materno'] . "</p>";
            }
            ...
            while ($hermano = $stmtHermanos->fetch()) {
                echo "<p>Hermano: " . $hermano['Nombre'] . " " . $hermano['Apellido_Paterno'] . " " . $hermano['Apellido_Materno'] . "</p>";
            }
    ...
    ?>
    <a href="editar_personas.php?persona=<?php echo $personaID; ?>">Editar Persona</a>
</body>
</html>
